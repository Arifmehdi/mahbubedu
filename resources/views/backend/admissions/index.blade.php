        ...
        <div class="box">
                <div class="row align-items-center">
                    <div class="box-header with-border col-6">
                        <h4 class="box-title">Admission List</h4>
                        {{-- <p class="mb-0 box-subtitle">Export data to Copy, CSV, Excel, PDF & Print</p> --}}
                    </div>
                    <div class="col-6 text-end">
                        <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#myModal" class="btn btn-success mt-10  text-center">+ New Admission</a>
                    </div>
                </div>
...
$(document).ready(function () {
    $('#createClassBtn').on('click', function (e) {
        ...
        // Make AJAX request
        $.ajax({
            url: "{{ route('admissions.store') }}", // Ensure this route exists
