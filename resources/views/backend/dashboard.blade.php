	...
	<div class="d-flex align-items-center logo-box justify-content-start">
		...
		<a href="index.html" class="logo">
		  ...
		  <div class="logo-mini w-30">
			  <span class="light-logo"><img src="{{ asset('backend/main') }}/images/logo-letter.png" alt="logo"></span>
			  <span class="dark-logo"><img src="{{ asset('backend/main') }}/images/logo-letter-white.png" alt="logo"></span>
		  </div>
		  <div class="logo-lg">
			  <span class="light-logo"><img src="{{ asset('backend/main') }}/images/logo-dark-text.png" alt="logo"></span>
			  <span class="dark-logo"><img src="{{ asset('backend/main') }}/images/logo-light-text.png" alt="logo"></span>
		  </div>
		</a>
	</div>
    <!-- Header Navbar -->
				...
				<div class="col-xl-9 col-12">
					<div class="box bg-success">
						<div class="box-body d-flex p-0">
							<div class="flex-grow-1 p-30 flex-grow-1 bg-img bg-none-md" style="background-position: right bottom; background-size: auto 100%; background-image: url(https://edulearn-lms-admin-template.multipurposethemes.com/images/svg-icon/color-svg/custom-30.svg)">
								<div class="row">
								...
								<div class="d-flex align-items-center justify-content-between">
									<div class="d-flex align-items-center">
										<div class="me-15 mb-1">
											<img src="{{ asset('backend/main') }}/images/avatar/avatar-1.png" class="bg-primary-light avatar avatar-lg rounded-circle" alt="">
										</div>
										<div class="d-flex flex-column fw-500">
						...
						<div class="box mb-15 pull-up">
							<div class="box-body">
								<div class="d-flex align-items-center justify-content-between">
									<div class="d-flex align-items-center">
										<div class="me-15 mb-1">
											<img src="{{ asset('backend/main') }}/images/avatar/avatar-2.png" class="bg-primary-light avatar avatar-lg rounded-circle" alt="">
										</div>
										<div class="d-flex flex-column fw-500">
								...
								<div class="d-flex align-items-center justify-content-between">
									<div class="d-flex align-items-center">
										<div class="me-15" style="margin-bottom: 1px;">
											<img src="{{ asset('backend/main') }}/images/avatar/avatar-3.png" class="bg-primary-light avatar avatar-lg rounded-circle" alt="">
										</div>
										<div class="d-flex flex-column fw-500">
						...
						<div class="box mb-15 pull-up">
							<div class="box-body">
								<div class="d-flex align-items-center justify-content-between">
									<div class="d-flex align-items-center">
										<div class="me-15">
											<img src="{{ asset('backend/main') }}/images/avatar/avatar-4.png" class="bg-primary-light avatar avatar-lg rounded-circle" alt="">
										</div>
										<div class="d-flex flex-column fw-500">
		  ...
		  <div class="modal-body p-30 bg-white">
            ...
            <div>
                <div class="d-flex flex-row">
                    <div class=""><img src="{{ asset('backend/main') }}/images/avatar/avatar-13.png" alt="user" class="rounded bg-danger-light w-150" width="100"></div>
                    <div class="ps-20">
          ...
          <div class="media-list media-list-hover mt-20">
			<div class="media py-10 px-0">
			  <a class="avatar avatar-lg status-success" href="#">
				<img src="{{ asset('backend/main') }}/images/avatar/1.jpg" alt="...">
			  </a>
			  <div class="media-body">
				<p class="fs-16">
			...
			<div class="media py-10 px-0">
			  <a class="avatar avatar-lg status-danger" href="#">
				<img src="{{ asset('backend/main') }}/images/avatar/2.jpg" alt="...">
			  </a>
			  <div class="media-body">
				<p class="fs-16">
			...
			<div class="media py-10 px-0">
			  <a class="avatar avatar-lg status-warning" href="#">
				<img src="{{ asset('backend/main') }}/images/avatar/3.jpg" alt="...">
			  </a>
			  <div class="media-body">
				<p class="fs-16">
			...
			<div class="media py-10 px-0">
			  <a class="avatar avatar-lg status-primary" href="#">
				<img src="{{ asset('backend/main') }}/images/avatar/4.jpg" alt="...">
			  </a>
			  <div class="media-body">
				<p class="fs-16">
				  <a class="hover-primary" href="#"><strong>Evan</strong></a>
...
<!-- ./wrapper -->
                ...
                <div class="chat-logs">
                    <div class="chat-msg user">
                        <div class="d-flex align-items-center">
                            <span class="msg-avatar">
                                <img src="{{ asset('backend/main') }}/images/avatar/2.jpg" class="avatar avatar-lg" alt="">
                            </span>
                            <div class="mx-10">
                    ...
                    <div class="chat-msg self">
                        <div class="d-flex align-items-center justify-content-end">
                            ...
                            <span class="msg-avatar">
                                <img src="{{ asset('backend/main') }}/images/avatar/3.jpg" class="avatar avatar-lg" alt="">
                            </span>
                        </div>
                        <div class="cm-msg-text">
	...
	<script src="{{ asset('backend/main') }}/assets/vendor_components/apexcharts-bundle/dist/apexcharts.js"></script>
	<script src="{{ asset('backend/main') }}/assets/vendor_components/moment/min/moment.min.js"></script>
	<script src="{{ asset('backend/main') }}/assets/vendor_components/bootstrap-daterangepicker/daterangepicker.js"></script>

	<!-- edulearn App -->
	<script src="{{ asset('backend') }}/src/js/demo.js"></script>
